...
BEGIN
    ...
    BEGIN TRY
		...
		PRINT '>> Inserting Data Into: edw.crm_cust_info';
		...
		PRINT '>> Inserting Data Into: edw.crm_prd_info';
		...
		PRINT '>> Inserting Data Into: edw.crm_sales_details';
		...
		SELECT 
			...
			END AS sls_price
		FROM Inventory.crm_sales_details;
        SET @end_time = GETDATE();
        PRINT '>> Load Duration: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT '>> -------------';
		...
		PRINT '>> Inserting Data Into: edw.erp_cust_az12';
		...
		PRINT '>> Inserting Data Into: edw.erp_loc_a101';
		...
		PRINT '>> Inserting Data Into: edw.erp_px_cat_g1v2';
		...
		SELECT
			...
			subcat,
			maintenance
		FROM Inventory.erp_px_cat_g1v2;
		SET @end_time = GETDATE();
		PRINT '>> Load Duration: ' + CAST(DATEDIFF(SECOND, @start_time, @end_time) AS NVARCHAR) + ' seconds';
        PRINT '>> -------------';
		...
		PRINT '=========================================='
		PRINT 'Loading edw Layer is Completed';
	...
	BEGIN CATCH
		PRINT '=========================================='
		PRINT 'ERROR OCCURED DURING LOADING Inventory LAYER'
